...
//     if (countries[i].id === 11070) {
//       console.log(countries[i].shipAddress.country);
//       break;
//     }
//   }
...
//   for (let i = 0; i < countries.length; i++) {
//     if (countries[i].shipAddress.country === "Germany") {
...
//Task3
  ...
  for (let i = 0; i < countries.length; i++) {
    if (countries[i].id === 11065) {
      console.log(`Shipname is : ${countries[i].shipName}`);
      console.log(`Country is : ${countries[i].shipAddress.country}`);
      console.log(`City is : ${countries[i].shipAddress.city}`);
      break;
    }
  }
...
// for (let i = 0; i < countries.length; i++) {
//   if (countries[i].id === 10550) {
//     console.log(countries[i].details.length);
//     break;
//   }
// }
...
// for (let i = 0; i < countries.length; i++) {
//     if (countries[i].id === 10310) {
//       let totalRevenue = 0;
  
//       for (let j = 0; j < countries[i].details.length; j++) {
//         let discountedPrice = countries[i].details[j].unitPrice * countries[i].details[j].quantity * (1 - countries[i].details[j].discount);
